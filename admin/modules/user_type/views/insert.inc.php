...
<!-- /.row -->
<form role="form" method="post" onsubmit="return check();" action="index.php?content=user_type&action=add" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="user_type_name" name="user_type_name" class="form-control">
