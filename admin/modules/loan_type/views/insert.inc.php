    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();" action="index.php?content=loan_type&action=add" enctype="multipart/form-data">
                    <div class="row">  
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>ชื่อประเภทเงินกู้ <font color="#F00"><b>*</b></font></label>
                                <input id="loan_type_name" name="loan_type_name" class="form-control"  >
                            </div>
                        </div>   
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group" >
                                <label>ไอคอน </label>
                                <img id="img_loan_type_icon" src="../img_upload/loan_type/default.png" class="img-fluid"  > 
                                <input accept=".jpg , .png" type="file" id="loan_type_icon" name="loan_type_icon" class="form-control" style="" onChange="readURL(this,'loan_type_icon');">
                            </div>
                        </div> 
                    </div>
                    <div class="row">  
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="loan_type_title" name="loan_type_title" class="form-control" >
                            </div>
                        </div>   
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>รายละเอียด </label> 
                                <textarea id="loan_type_detail" name="loan_type_detail" class="form-control" style="min-height: 200px;"/></textarea>
                            </div>
                        </div>   
                    </div> 
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group" >
                                ...
                                <img id="img_loan_type_img" src="../img_upload/loan_type/default.png" class="img-fluid"> 
                                <input accept=".jpg , .png" type="file" id="loan_type_img" name="loan_type_img" class="form-control" style="" onChange="readURL(this,'loan_type_img');">
                            </div>
                        </div> 
                    </div>
